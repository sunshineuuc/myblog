...
安全类包含了一些方法，用于安全的处理输入数据，有助于创建一个安全的应用。CI框架安全类提供了跨站请求伪造**CSRF攻击**和**XSS跨站脚本攻击**策略，只需要在配置文件开启即可。该类包含9个成员变量和22个成员方法。
<!-- more -->
---
...
[CI框架源码解析十一之安全类文件Security.php](https://blog.csdn.net/Zhihua_W/article/details/52936402)